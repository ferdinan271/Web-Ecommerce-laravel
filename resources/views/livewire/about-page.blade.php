   ...
   <div class="container">
    ...
    {{-- <dh-component>
        <div class="container flex justify-center mx-auto ">
            <div>
                <h1 class="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold my-40 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the Organization</h1>
            </div>
        </div>
