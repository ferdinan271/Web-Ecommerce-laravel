					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								<input wire:model='first_name' class="w-full rounded-lg  border py-2 px-3 shadow   " id="first_name" type="text">
								</input>
								@error('first_name')
							...
							<div>
								...
								<input wire:model='last_name' class="w-full rounded-lg border py-2 px-3 shadow   @error('last_name') border-red-500 @enderror" id="last_name" type="text">
								</input>
								@error('last_name')
								<div class="text-red-500 text-sm">{{$message}}</div>
								@enderror
						...
						<div class="mt-4">
							...
							<input wire:model='phone' class="w-full rounded-lg border py-2 px-3 shadow " id="phone" type="text">
							</input>
							@error('phone')
								<div class="text-red-500 text-sm">{{$message}}</div>
								@enderror
						...
						<div class="mt-4">
							...
							<input wire:model='city' class="w-full rounded-lg border py-2 px-3 shadow " id="city" type="text">
							</input>
							@error('city')
								<div class="text-red-500 text-sm">{{$message}}</div>
								@enderror
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div>
								...
								<input wire:model='state' class="w-full rounded-lg border py-2 px-3 shadow " id="state" type="text">
								</input>
								@error('state')
								<div class="text-red-500 text-sm">{{$message}}</div>
								@enderror
