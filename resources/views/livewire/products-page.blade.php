        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            ...
            <div class="w-full pr-2 lg:w-1/4 lg:block">
                ...
                <ul>
                    ...
                    <label for="{{$category -> slug}}" class="flex items-center dark:text-gray-400 ">
                        <input type="checkbox" wire:model.live="selected_categories" id="{{$category -> slug}}" value="{{$category -> id}}" class="w-4 h-4 mr-2 form-check-input mt-0"      >
                ...
                <ul>
                    ...
                    <label for="{{$brand -> slug}}" class="flex items-center dark:text-gray-400 ">
                        <input type="checkbox" wire:model.live="selected_brands" id="{{$brand -> slug}}" value="{{$brand -> id}}" class="w-4 h-4 mr-2 form-check-input mt-0" >
            ...
            <div class="w-full px-3 lg:w-3/4">
                ...
                <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex  ">
                    ...
                    <select name="" id="" class="block w-40 text-base bg-gray-100 cursor-pointer dark:text-gray-400 ">
                ...
                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                    ...
                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                        ...
                        </svg><span wire:loading.remove wire:target='addToCart({{$product->id}})'>Add to Cart</span><span wire:loading wire:target='addToCart({{$product->id}})'>
                            Adding...
                        </span>
                        </a>
