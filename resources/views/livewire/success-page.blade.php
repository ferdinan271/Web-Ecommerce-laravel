    <section class="flex items-center font-poppins dark:bg-gray-200 ">
        ...
        <div>
            ...
            <div class="flex items-start justify-start flex-shrink-0">
                ...
                <div class="flex flex-col items-start justify-start space-y-2">
                    ...
                    <p class="text-sm leading-4 text-gray-600 ">{{$order->address->street_address}}</p>
                    <p class="text-sm leading-4 text-gray-600 ">
                        {{$order->address->city}},{{$order->address->state}} {{$order->address->zip_code}}
                    </p>
                    <p class="text-sm leading-4 cursor-pointer ">Phone: {{$order->address->phone}}</p>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
                ...
                <div class="flex items-start justify-between w-full">
                    ...
                    <p class="text-lg font-semibold leading-6 text-gray-800 ">00</p>
                </div>
                </div>
            </div>
            </div>
